...
<div id="userManagmentApp" style="display: none;" class="container-fluid" ng-app="userManagmentApp"
    ...
    <div class="row text-center">
        <div class="col-md-12 text-center"><h1 class="text-center">OpenIAM Ldap Web browser</h1></div>
    </div>
    <div class="row">
        <div class="col-md-3">
            ...
            <form>
                ...
                <input id="fillDefault" class="btn btn-lg" type='button' value="Fill test data"
                       ng-click="fill()"/>
...
<script>
    ...
    app.controller('userManagmentCtrl', function ($scope, $http) {
        ...
        $scope.fill = function (nodeObject) {
            $scope.connection = {
                url: "ldap://104.196.44.120:389",
                userName: "DEV\\Administrator",
                userPassword: "OpenIAM4u!!",
                baseDN: "dc=dev,dc=local",
                searchFilter: "(sn=task*)"
            };
